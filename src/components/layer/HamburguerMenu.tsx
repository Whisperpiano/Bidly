...
export default function HamburguerMenu() {
  ...
  return (
    <>
      ...
      <section>
        <div
          className={`fixed top-[87px] left-0 w-full h-screen bg-neutral-950/25 transition-all duration-800 overflow-hidden ${
            isOpen ? "opacity-100" : "opacity-0 pointer-events-none"
          }`}
        >
          <div
            className={`flex flex-col bg-neutral-50 dark:bg-neutral-950 h-screen max-w-[300px] ml-auto transition-all duration-800 ${
              isOpen ? "translate-x-10" : "translate-x-[200px]"
            }`}
            ref={menuRef}
          >
