    ...
    <article className="animate-reveal border dark:border-neutral-800 border-neutral-200  rounded-lg p-6 sticky top-6">
      ...
      <div className="flex items-center justify-between py-6">
        <div className="flex gap-4 items-center">
          <button className="flex gap-1 items-center text-sm dark:text-neutral-400 text-neutral-500 font-medium">
            <PiShareFatFill />
            Share
          </button>
          <button className="flex gap-1 items-center text-sm dark:text-neutral-400 text-neutral-500 font-medium">
        ...
        <button className="dark:text-neutral-400 text-neutral-500">
          <span className="sr-only">Options</span>
          <PiDotsThreeBold size={20} />
        </button>
      </div>
      <div className="grid grid-cols-2 gap-2 text-xs font-semibold">
        <div className="flex flex-col gap-1.5 border rounded-lg p-5 dark:bg-neutral-900 bg-neutral-100 dark:border-neutral-800 border-neutral-100">
