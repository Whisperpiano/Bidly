  ...
  return (
    <div className="relative">
        ...
        <button
          className={`rounded-lg text-sm flex items-center gap-2 h-[42px] aspect-square justify-center border  ${
            isOpen
              ...
              : "dark:bg-neutral-950 dark:text-neutral-400 dark:border-neutral-800 text-neutral-600 border-neutral-100 bg-neutral-100 "
          }`}
          aria-label="Account"
        >
          <PiUserFill size={18} />
      ...
      <div
        ...
        className={`absolute w-44 top-14 right-0 z-10 text-left divide-y rounded-lg shadow dark:bg-neutral-900 dark:divide-neutral-700/50 transition-all duration-200 ${
      ...
      >
        ...
        <ul className="py-2 text-sm dark:text-neutral-300">
          <li>
            <span className="px-4 py-2 dark:hover:bg-neutral-800 dark:hover:text-white flex items-center gap-1.5">
              <PiUserFill size={16} />
              My profile
            </span>
          </li>
        ...
        <div className="py-2 text-sm dark:text-neutral-300">
          <ul>
            <li>
              <span className="px-4 py-2 dark:hover:bg-neutral-800 dark:hover:text-white flex items-center gap-1.5">
                <PiGearFill size={16} />
            ...
            <li>
              <label className="inline-flex w-full items-center justify-between cursor-pointer px-4 py-2 dark:hover:bg-neutral-800 dark:hover:text-white">
                <input
                  type="checkbox"
