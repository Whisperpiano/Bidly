        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 z-10 flex flex-col items-center sm:items-start justify-center px-6 sm:px-12 md:px-16 lg:px-20 xl:px-24 bg-neutral-900/50">
            <div className="max-w-[450px] ">
              ...
              <button className="rounded-lg text-sm flex items-center gap-2 h-[36px] xs:h-[42px] px-4 justify-center text-neutral-950 bg-neutral-50 hover:bg-neutral-300 font-medium">
                Shop deals
              </button>
            </div>
          </div>
